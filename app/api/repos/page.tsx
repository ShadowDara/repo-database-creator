            ...
            <table className="w-full table-auto border-collapse border border-gray-300">
              ...
              <thead>
                <tr className="">
                  ...
                  {params.description === "true" && <th className="border border-gray-300 px-4 py-2 text-left">Description</th>}
                </tr>
              </thead>
              ...
              <tbody>
                {repos.map((repo) => (
                  <tr key={repo.id} className="hover:bg-gray-50">
                    ...
                    {params.language === "true" && <td className="border border-gray-300 px-4 py-2">{repo.language || "-"}</td>}
                    {params.description === "true" && <td className="border border-gray-300 px-4 py-2">{repo.description || "-"}</td>}
                  </tr>
                ))}
              </tbody>
